...
use crate::game::components::{Health, Player, DamageCooldown, Damage, Hitbox, CollidesPlayer};
...
pub fn damage_player(
    ...
    mut query: Query<(Option<&mut DamageCooldown>, &Damage, &Transform, &Hitbox, Entity), (With<CollidesPlayer>, Without<Player>)>,
) {
